...
/* ═══════════════════════════════════════════════
   LOGIN VIEW — Premium glass card login
   ═══════════════════════════════════════════════ */
      ...
      >
        ...
        <div className="rounded-[24px] bg-white/70 backdrop-blur-xl border border-[#E2E8F0]/60 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.02)] p-8 space-y-6">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-[14px] text-[#64748B] leading-relaxed">
              AI siap bantu operasional restoran setelah login.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none group">
                <div className="relative">
                  ...
                  />
                  <div
                    className={`w-4 h-4 rounded-[5px] border-2 transition-all duration-200 flex items-center justify-center ${
                      remember
            ...
            {showForgotHint && (
              ...
              >
                ...
                <span className="font-semibold">pemilik restoran</span> untuk mereset password Anda.
              </motion.div>
            )}
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-[11px] text-[#CBD5E1] text-center">
            Login aman — enkripsi end-to-end
          </p>
        </div>
      </motion.div>
    </div>
