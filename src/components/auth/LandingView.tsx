  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] overflow-x-hidden">
      ...
      {/* ══════════════════════════════════════
          ...
          ══════════════════════════════════════ */}
      <Section className="pt-12 sm:pt-20 pb-8 sm:pb-16">
      ...
      <div className="relative bg-[#0F172A] overflow-hidden">
        ...
        <Section className="relative">
          ...
          >
            ...
            <h2 className="text-[32px] sm:text-[40px] font-bold leading-[1.12] tracking-[-0.03em] text-white text-center">
